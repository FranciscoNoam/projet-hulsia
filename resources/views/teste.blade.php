            ...
            <div >
                ...
                <div >
                    ...
                    <form role="form" action="{{ route('payement.create2') }}" method="post"  id="payment-form">
                        @csrf
                       <input type="text" id="card-holder-name" name="nom">
                       ...
                       <div id="card-element"></div>
                        ...
                        {{-- <!-- <button id="card-button" data-secret="{{ $intent->client_secret }}">Payer</button> --> --}}
                            <!-- ======================= single payement  -->
                            <button type="button" id="card-button">Payer</button>
...
const payement_id = document.getElementById('payement_id');
const carte_type = document.getElementById('carte_type');
...
cardButton.addEventListener('click', async (e) => {
   ...
   /* const {setupIntent, error} = await stripe.handleCardSetup(
    ...
    if(error){
        ...
        payement_id.value = paymentMethod.id;
        carte_type.value = paymentMethod.card.brand;
